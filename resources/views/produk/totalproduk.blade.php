...
@if($jumlah > 0)
          <div class="row">
            ...
            <div class="card border-warning text-dark my-2 mx-4 " style="width: 18rem; height:19rem">
              ...
              <div class="card-footer text-center">
                  <a class="card-title  btn btn-sm btn-warning" href="{{ route('detailproduk', [$item['idskincare']]) }}">{{ $item['namaprod'] }}</a>
              </div>
          </div>
        ...
        @else
          <p class="font-weight-normal ml-3">Tidak ada data Produk Skincare</p>
        @endif
